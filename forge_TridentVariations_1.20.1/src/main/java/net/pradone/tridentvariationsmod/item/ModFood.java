...
public class ModFood {
    public static final FoodProperties WHITE_GOLD_BERRIES = new FoodProperties.Builder().nutrition(4).saturationMod(1.2f).fast()
            ...
            .effect(new MobEffectInstance(MobEffects.LUCK, 200,0),0.15F).alwaysEat().build();

    public static final FoodProperties PINK_GOLD_BERRIES = new FoodProperties.Builder().nutrition(5).saturationMod(1.2f).fast()
            .effect(new MobEffectInstance(MobEffects.REGENERATION, 200, 1), 1.0F)
            .effect(new MobEffectInstance(MobEffects.ABSORPTION, 1200, 0), 1.0F)
            .effect(new MobEffectInstance(MobEffects.SATURATION, 350,0),0.25F).alwaysEat().build();
}
