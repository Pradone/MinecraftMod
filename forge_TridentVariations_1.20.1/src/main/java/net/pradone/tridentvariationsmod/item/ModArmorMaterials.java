...
public enum ModArmorMaterials implements ArmorMaterial {
    WHITE_GOLD("white_gold", 20, new int[]{ 3, 6, 5, 2 },28,
            SoundEvents.ARMOR_EQUIP_GOLD,1f,0.1f, ()  ->  Ingredient.of(ModItems.WHITE_GOLD_INGOT.get())),

    PINK_GOLD("pink_gold", 15, new int[]{ 3, 6, 5, 2 },28,
            SoundEvents.ARMOR_EQUIP_GOLD,0.5f,0f, ()  ->  Ingredient.of(ModItems.PINK_GOLD_INGOT.get()));
    ...
    public String getName() {
        return TridentVariationsMod.MOD_ID + ":" + this.name;
    }
